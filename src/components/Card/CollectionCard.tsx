      ...
      <div onClick={open} className={style.card}>
        <div className={style.cardContent}>
          ...
          <div onClick={(e)=>e.stopPropagation()} className={style.cardTop}>
            ...
            <svg style={{marginLeft:'12px'}} onClick={() => patchData('like')} width="32" height="27" viewBox="0 0 32 27" fill={data?.data?.isLiked?"red":'none'} xmlns="http://www.w3.org/2000/svg">
...
export const Star=(props:any)=>{
  return(
      ...
      <svg onClick={props.click}width="32" height="26" viewBox="0 0 32 26" fill="red" xmlns="http://www.w3.org/2000/svg">
