            ...
            >
              ...
              <div className={style.pricesBx}>
                <div className={style.pbItem}>
                  <p>Service pay </p>
                  <p>0.001 {props.nftDetails?.chain === "rinkeby" ? 'ETH' : props.nftDetails?.chain === "bsc testnet" ? 'BNB' : ''}</p>
                </div>
                <div className={style.pbItem}>
                  <p>Amount </p>
                  <p>
                    {Web3.utils.fromWei(props.nftDetails?.price.toString(), 'ether') || ''}{' '}
                    {props.nftDetails?.chain === "rinkeby" ? 'ETH' : props.nftDetails?.chain === "bsc testnet" ? 'BNB' : ''}
                  </p>
                </div>
